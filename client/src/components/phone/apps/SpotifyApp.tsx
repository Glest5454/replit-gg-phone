import { ArrowLeft, Play, Pause, SkipBack, SkipForward, Heart, MoreHorizontal, Shuffle, Repeat } from 'lucide-react';
      ...
      <div className="px-8 py-6">
        <div className="flex items-center justify-between mb-2">
          <div className="flex-1">
            <h2 className="text-white text-2xl font-bold mb-1" data-testid="track-title">
              {currentTrack.title}
            </h2>
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between text-white/60 text-sm">
            ...
            <span data-testid="total-time">{formatTime(currentTrack.duration)}</span>
          </div>
        </div>
